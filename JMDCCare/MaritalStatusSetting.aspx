<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MaritalStatusSetting.aspx.cs" Inherits="MaritalStatusSetting" %>
                        ...
                        <div class="x_content">
                            ...
                            <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                   <asp:Label id="lblMaritalStatus" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" for="Class-name">
                                         Marital Status <span class="required">*</span>
                                    </asp:Label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" maxlength="50" runat="server" id="txtMaritalStatus" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
    ...
    <script type="text/javascript">
        ...
        function fControlStatus() {
            ...
            if (hdnFlagValue == "") {
                ...
                $('#<%=btnDelete.ClientID%>').attr('disabled', false);
                $('#<%=txtMaritalStatus.ClientID%>').prop("disabled", false);
                $('#<%=txtMaritalStatus.ClientID%>').focus();
            }
