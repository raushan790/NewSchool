<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BloodGroupSetting.aspx.cs" Inherits="BloodGroupSetting" %>
                        ...
                        <div class="x_content">
                            ...
                            <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    <label id="lblBloodGroup" runat="server" class="control-label col-md-3 col-sm-3 col-xs-12" for="Class-name">
	                                        Blood Group   </label><span class="required">*</span>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" maxlength="50" runat="server" id="txtBloodGroup" required="required" class="form-control col-md-7 col-xs-12">
                                         </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="end" runat="Server">
    ...
    for (i = 0; i < rows.length; i++) {
        ...
        var createClickHandler = 
            ...
            {
                return function () {
                                        $('#<%=txtBloodGroup.ClientID%>').val(row.getElementsByTagName("td")[0].innerHTML);
                                        $('#<%=hdnFlag.ClientID%>').val(row.getElementsByTagName("td")[0].innerHTML);
                                        $('#<%=txtBloodGroup.ClientID%>').prop("disabled", true);
